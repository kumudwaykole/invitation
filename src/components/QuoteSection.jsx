...
export default function QuoteSection() {
    ...
    return (
        <section
            ref={ref}
            className="relative flex min-h-[82vh] w-full items-center justify-center overflow-hidden bg-[#ead8bd] bg-[url('/bg-flower1.webp')] bg-cover bg-center px-3.5 py-9"
        >
            ...
            >
                <blockquote className="relative z-10 mx-0 mb-6 mt-8 px-8 pt-10 text-center font-['Cormorant_Garamond',Georgia,serif] text-[#3b1f0a]">
